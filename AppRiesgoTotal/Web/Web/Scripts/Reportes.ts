...
head.ready(function () {
    ...
    $('#btn_Buscar').click(function () {
        ...
        var filtro: FacturacionFilter = new FacturacionFilter();
       ...
       if ($('#grid_facturacion').data().kendoGrid) {
        ...
        post$facturacion$ConsultarReporteGeneralFacturacion(filtro,
            function (res: Msg) {
                var lst: Array<Facturacion_ReporteGeneral> = res.Datos;
                for (let i of lst) {
    ...
    function DescargarXML2(CodigoProducto, CodigoSucursal, CodigoSerie, NumeroFactura) {
        ...
        get$ebilling$ConsultaFacturaXml(NFactura,
            function (res) {
    ...
    function DescargarRIDE2(diCodigoProducto, diCodigoSucursal, diSerieFacturacion, diNumeroFactura) {
        ...
        get$ebilling$ConsultaFacturaPdf(NFactura,
            function (res) {
    ...
    function DescargarSoportes2(IDEmpresa, IDSucursal, IDCuota) {
        ...
        get$facturacion$ObtenerDatosReporteSoportesFactura(IDEmpresa, IDSucursal, IDCuota, 1,
    ...
    function DescargarSoportesExcel2(IDEmpresa, IDSucursal, IDCuota) {
        ...
        get$facturacion$ObtenerDatosReporteSoportesFactura(IDEmpresa, IDSucursal, IDCuota, 2,
    ...
    function VerCuota(NumeroFactura, ValorCouta, ValorServiciosAdicionales, ValorGastosAdministrativos,
        ValorTarjeta, ValorSeguroCampesino, ValorTotal) {
