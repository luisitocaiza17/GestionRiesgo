head.ready(function () {
    ...
    var agenteListaInicial: ContratoEntityFilter = new ContratoEntityFilter();
    ...
    if (UsuarioLogueado.CodigoGrupoAgentes == null || UsuarioLogueado.CodigoGrupoAgentes == undefined || UsuarioLogueado.CodigoGrupoAgentes == 0 || UsuarioLogueado.rol[0].Id == 1 || UsuarioLogueado.rol[0].Id == 3) {
        ...
        post$CorredoresAgenteVenta$ConsultarEmpresasPorAgente(agenteListaInicial,
            function (res) {
                var Empresas = <Array<Empresa>>res.Datos;
    ...
    function LoadGrids() {
        ...
        get$masivo$ObtenerConsolidadoRegistrosCarga(Number(selecionado),
            function (result: Msg) {

                var estadisticaGeneral = <ResumenConsolidadoRegistrosCarga>result.Datos;
                var colores = rainbow();
        ...
        get$masivo$ObtenerRegistrosCargaPorEmpresa(Number(selecionado),
            function (result: Msg) {

                var lstEstadistica = <registroEstadistica[]>result.Datos;
                lstEstadistica.forEach(function (v: registroEstadistica) {
