head.ready(function () {
    ...
    if (UsuarioLogueado.CodigoGrupoAgentes == null || UsuarioLogueado.CodigoGrupoAgentes == undefined || UsuarioLogueado.CodigoGrupoAgentes == 0 || UsuarioLogueado.rol[0].Id == 1 || UsuarioLogueado.rol[0].Id == 3) {
        ...
        var filtro = new ResumenEjecutivoFilter();
        var listaBroker = new Array();
        ...
        if (planes != null && planes.length > 0) {
            ...
            for (var i = 0; i < listPlanes.length - 1; i++) {
                if (listPlanes[i] == 'IND') {
                    ...
                    post$CorredoresResumenEjecutivoController$CorredoresResumenEjecutivoProducto(filtro, function (res) {
...
//# sourceMappingURL=ResumenEjecutivo.js.map