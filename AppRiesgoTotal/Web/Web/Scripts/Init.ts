...
head.load("../js/kendoui/js/jquery.min.js", "../Config.js", function () {
    ...
    if ((filename != 'Login.html' && filename != "RecuperarClave.htm" && filename != "ActivacionUsuario.html") &&
        ...
        head.load("../js/kendoui/js/kendo.all.min.js",
            ...
            "../js/cryptojs/src/core.js",
            "../js/cryptojs/src/enc-base64.js",
            "../js/cryptojs/src/md5.js",
            "../js/cryptojs/src/evpkdf.js",
            "../js/cryptojs/src/cipher-core.js",
            "../js/cryptojs/src/aes.js",
            //"../js/tooltip/js/Tooltip.js",
            "../js/slick/slick/slick.min.js",
            "../Styles/Site.css",
            "../js/slick/slick/slick.css",
            "../js/slick/slick/slick-theme.css",
            '../js/kendoui/styles/kendo.common-material.min.css',
            '../js/kendoui/styles/kendo.material.min.css',
            '../js/kendoui/styles/kendo.material.mobile.min.css',
